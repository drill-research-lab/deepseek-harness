...
| [pipeline.md](pipeline.md) | the scheduled pipeline seam: `PipelineEngine` (list/get/save/delete/setEnabled/startRun), the `pipeline/*` event payloads, run records and D13 retention |
