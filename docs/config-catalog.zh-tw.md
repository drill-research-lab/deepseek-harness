<!-- 英文原始檔由 scripts/gen-config-catalog.ts 生成；本中文文件是透過雙語配對維護的經評審對側。
     更新時先執行 `pnpm run gen-config-catalog` 更新英文，再更新本文件並執行 `pnpm run verify-translation-pairing --write docs/config-catalog.md` 重新記錄配對。 -->
...
英文原始檔由原始碼（`scripts/gen-config-catalog.ts`）生成，並透過 `pnpm run verify-config-catalog`（`doc-sync` 的一部分）驗證新鮮度；本中文文件作為經評審對側透過雙語配對維護。聲明塊使用 `ts config-catalog` 圍欄（doc-typecheck 會跳過它，因為單獨引用匯入項的聲明無法獨立編譯）。英文生成器還會將執行時期 schemastery schema 與貼上的聲明進行交叉核對——每個經 schema 驗證的鍵（包括巢狀鍵）都必須能在聲明的設定類型中找到——因此，貼上內容無法隱藏載入器接受的欄位。

`Requires:` 行列出外掛程式透過 `inject` 注入的服務鍵：其 `cordis.yml` 樹還必須載入這些服務的提供者。範圍限定為 harness 層級（`packages/`）；設定樹還可能載入的 vendored cordis 外掛程式（`hmr`、控制台日誌記錄器等）固定為上游原始碼（參見 [vendoring policy](../vendor/README.md)），未收錄於此目錄。
...
相依性：`Stream`（`@agentclientprotocol/sdk`）

來源：[`packages/acp/acp/src/index.ts:70`](../packages/acp/acp/src/index.ts)
...
相依性：[`agentCore`](../packages/examples/agent-spine-demo/src/index.ts) · [`JsonlCompression`](../packages/session/session-persistence-jsonl/src/index.ts) · [`ToolsConfig`](#deepseek-aidsh-tools)

來源：[`packages/examples/acp-demo/src/index.ts:39`](../packages/examples/acp-demo/src/index.ts)
...
相依性：[`AgentOptions`](subsystems/core.md) · [`SessionId`](subsystems/core.md)

來源：[`packages/core/agent-loop/src/index.ts:255`](../packages/core/agent-loop/src/index.ts)
...
相依性：[`ToolPresentationMode`](subsystems/tools.md)
...
相依性：[`LocalConfig`](#deepseek-aidsh-bash-local)

來源：[`packages/shell/bash-sandbox/src/index.ts:35`](../packages/shell/bash-sandbox/src/index.ts)
...
來源：[`packages/compaction/compaction-tool-result-pruner/src/types.ts:4`](../packages/compaction/compaction-tool-result-pruner/src/types.ts)
...
來源：[`packages/credentials/credentials-local/src/index.ts:55`](../packages/credentials/credentials-local/src/index.ts)
...
來源：[`packages/e2b/e2b/src/index.ts:43`](../packages/e2b/e2b/src/index.ts)
...
相依性：[`LocalConfig`](#deepseek-aidsh-fs-local)

來源：[`packages/fs/fs-sandbox/src/index.ts:50`](../packages/fs/fs-sandbox/src/index.ts)
...
來源：[`packages/goal/goal/src/index.ts:116`](../packages/goal/goal/src/index.ts)
...
來源：[`packages/bundle/headless/src/index.ts:31`](../packages/bundle/headless/src/index.ts)
...
來源：[`packages/hooks/hooks-claude-code/src/index.ts:45`](../packages/hooks/hooks-claude-code/src/index.ts)
...
來源：[`packages/hooks/hooks-codex/src/index.ts:44`](../packages/hooks/hooks-codex/src/index.ts)
...
來源：[`packages/host/apiproxy/src/index.ts:46`](../packages/host/apiproxy/src/index.ts)
...
來源：[`packages/host/authentication/src/index.ts:11`](../packages/host/authentication/src/index.ts)
...
來源：[`packages/host/directory-picker-browse/src/index.ts:200`](../packages/host/directory-picker-browse/src/index.ts)
...
來源：[`packages/host/webserver/src/index.ts:45`](../packages/host/webserver/src/index.ts)
...
相依性：[`RetryPolicyConfig`](../packages/llm/llm/src/index.ts)

來源：[`packages/llm/llm-deepseek/src/index.ts:62`](../packages/llm/llm-deepseek/src/index.ts)
...
相依性：`Api`（`@earendil-works/pi-ai`）· `CacheRetention`（`@earendil-works/pi-ai`）· `Model`（`@earendil-works/pi-ai`）· `ModelThinkingLevel`（`@earendil-works/pi-ai`）· `OpenAICompletionsCompat`（`@earendil-works/pi-ai`）· [`RetryPolicyConfig`](../packages/llm/llm/src/index.ts) · `ThinkingBudgets`（`@earendil-works/pi-ai`）· `Transport`（`@earendil-works/pi-ai`）

來源：[`packages/llm/llm-pi-ai/src/config.ts:172`](../packages/llm/llm-pi-ai/src/config.ts)
...
相依性：[`ModelModality`](../packages/llm/llm/src/index.ts) · [`RetryPolicyConfig`](../packages/llm/llm/src/index.ts)

來源：[`packages/test-support/llm-replay/src/index.ts:776`](../packages/test-support/llm-replay/src/index.ts)
...
來源：[`packages/llm/llm-retry/src/index.ts:24`](../packages/llm/llm-retry/src/index.ts)
...
來源：[`packages/feedback/message-feedback/src/index.ts:49`](../packages/feedback/message-feedback/src/index.ts)
...
相依性：[`ApprovalPolicy`](subsystems/approval.md) · [`SandboxMode`](subsystems/sandbox.md)

來源：[`packages/interaction/permission-presets/src/index.ts:140`](../packages/interaction/permission-presets/src/index.ts)
...
來源：[`packages/preset/persona/src/index.ts:34`](../packages/preset/persona/src/index.ts)
...
來源：[`packages/plan/plan-mode/src/index.ts:70`](../packages/plan/plan-mode/src/index.ts)
...
相依性：[`LocalConfig`](#deepseek-aidsh-pwsh-local)
...
來源：[`packages/sandbox/sandbox-local/src/index.ts:56`](../packages/sandbox/sandbox-local/src/index.ts)
...
相依性：[`SandboxMode`](subsystems/sandbox.md)

來源：[`packages/sandbox/sandbox-policy/src/index.ts:80`](../packages/sandbox/sandbox-policy/src/index.ts)
...
相依性：`Readable`（`node:stream`）· `Writable`（`node:stream`）

來源：[`packages/sdk/server/src/index.ts:29`](../packages/sdk/server/src/index.ts)
...
來源：[`packages/session/session-persistence-jsonl/src/index.ts:60`](../packages/session/session-persistence-jsonl/src/index.ts)
...
來源：[`packages/session/session-persistence-sqlite/src/index.ts:70`](../packages/session/session-persistence-sqlite/src/index.ts)
...
來源：[`packages/session/session-projection-cache/src/index.ts:42`](../packages/session/session-projection-cache/src/index.ts)
...
相依性：[`SessionQueryConfig`](../packages/session-query/session-query/src/index.ts)

來源：[`packages/session-query/session-query-sqlite/src/index.ts:89`](../packages/session-query/session-query-sqlite/src/index.ts)
...
相依性：`BatchLogRecordProcessorOptions`（`@opentelemetry/sdk-logs`）· `OTLPExporterNodeConfigBase`（`@opentelemetry/otlp-exporter-base`）

來源：[`packages/session/session-telemetry-otel/src/index.ts:91`](../packages/session/session-telemetry-otel/src/index.ts)
...
來源：[`packages/session/session-title/src/index.ts:79`](../packages/session/session-title/src/index.ts)
...
相依性：[`SessionTitleLlmConfig`](../packages/session/session-title-llm/src/index.ts)
...
來源：[`packages/settings/settings-file/src/index.ts:21`](../packages/settings/settings-file/src/index.ts)
...
來源：[`packages/shell/shell-env/src/index.ts:29`](../packages/shell/shell-env/src/index.ts)
...
來源：[`packages/skill/skill/src/index.ts:279`](../packages/skill/skill/src/index.ts)
...
來源：[`packages/spill/spill-local/src/index.ts:22`](../packages/spill/spill-local/src/index.ts)
...
來源：[`packages/spill/spill-policy/src/index.ts:60`](../packages/spill/spill-policy/src/index.ts)
...
來源：[`packages/storage/storage-json/src/index.ts:27`](../packages/storage/storage-json/src/index.ts)
...
來源：[`packages/subagent/subagent-claude-code/src/index.ts:32`](../packages/subagent/subagent-claude-code/src/index.ts)
...
來源：[`packages/subagent/subagent-codex/src/index.ts:30`](../packages/subagent/subagent-codex/src/index.ts)
...
來源：[`packages/subagent/subagent-dsh-sdk/src/index.ts:29`](../packages/subagent/subagent-dsh-sdk/src/index.ts)
...
來源：[`packages/e2b/subprocess-e2b/src/index.ts:25`](../packages/e2b/subprocess-e2b/src/index.ts)
...
來源：[`packages/core/system-prompt/src/index.ts:186`](../packages/core/system-prompt/src/index.ts)
...
來源：[`packages/terminal/terminal-bash/src/config.ts:6`](../packages/terminal/terminal-bash/src/config.ts)
...
來源：[`packages/context/time-context/src/index.ts:27`](../packages/context/time-context/src/index.ts)
...
來源：[`packages/context/tmux-context/src/index.ts:34`](../packages/context/tmux-context/src/index.ts)
...
來源：[`packages/llm/token-meter/src/types.ts:12`](../packages/llm/token-meter/src/types.ts)
...
來源：[`packages/shell/tool-bash/src/index.ts:34`](../packages/shell/tool-bash/src/index.ts)
...
來源：[`packages/shell/tool-bash-persistent/src/index.ts:405`](../packages/shell/tool-bash-persistent/src/index.ts)
...
來源：[`packages/fs/tool-fs-search/src/index.ts:75`](../packages/fs/tool-fs-search/src/index.ts)
...
來源：[`packages/goal/tool-goal/src/index.ts:26`](../packages/goal/tool-goal/src/index.ts)
...
來源：[`packages/jobs/tool-jobs/src/index.ts:32`](../packages/jobs/tool-jobs/src/index.ts)
...
來源：[`packages/lsp/tool-lsp/src/index.ts:58`](../packages/lsp/tool-lsp/src/index.ts)
...
來源：[`packages/shell/tool-pwsh/src/index.ts:52`](../packages/shell/tool-pwsh/src/index.ts)
...
來源：[`packages/workflow/tool-ralph/src/index.ts:23`](../packages/workflow/tool-ralph/src/index.ts)
...
來源：[`packages/session-query/tool-session-query/src/index.ts:29`](../packages/session-query/tool-session-query/src/index.ts)
...
來源：[`packages/fs/tool-str-replace-editor/src/index.ts:501`](../packages/fs/tool-str-replace-editor/src/index.ts)
...
相依性：[`AgentOptions`](subsystems/core.md)

來源：[`packages/subagent/tool-subagent/src/index.ts:29`](../packages/subagent/tool-subagent/src/index.ts)
...
相依性：[`SubagentReportDelivery`](subsystems/subagent.md)

來源：[`packages/subagent/tool-subagent-report/src/index.ts:27`](../packages/subagent/tool-subagent-report/src/index.ts)
...
來源：[`packages/workflow/tool-workflow/src/index.ts:33`](../packages/workflow/tool-workflow/src/index.ts)
...
來源：[`packages/core/tools/src/index.ts:654`](../packages/core/tools/src/index.ts)
...
來源：[`packages/interaction/user-approval/src/index.ts:177`](../packages/interaction/user-approval/src/index.ts)
...
來源：[`packages/bundle/web-app/src/index.ts:38`](../packages/bundle/web-app/src/index.ts)
...
來源：[`packages/web/web-fetch-http/src/index.ts:34`](../packages/web/web-fetch-http/src/index.ts)
...
來源：[`packages/web/web-search-exa/src/index.ts:38`](../packages/web/web-search-exa/src/index.ts)
...
來源：[`packages/web/web-search-perplexity/src/index.ts:32`](../packages/web/web-search-perplexity/src/index.ts)
...
這些外掛程式透過 `cordis.yml` 中不含 `config:` 塊的條目載入；它們未聲明任何設定介面。
