...
來源：[`packages/acp/acp/src/index.ts:71`](../packages/acp/acp/src/index.ts)
...
來源：[`packages/shell/tool-bash-persistent/src/index.ts:400`](../packages/shell/tool-bash-persistent/src/index.ts)
