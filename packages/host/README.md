...
| [`authentication/`](authentication/README.md) | External identity-cookie verification and request identity | `ctx.auth` |
| [`ownership-file/`](ownership-file/README.md) | File-backed owner homes and Linux single-writer enforcement | `ctx.ownership` |
