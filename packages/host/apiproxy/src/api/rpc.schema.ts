...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('workspace-outside-owner-root'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('cwd-outside-owner-root'), message: z.string(), details: z.object({ cwd: z.string() }) }),
  ...
  z.object({ code: z.literal('directory-outside-owner-root'), message: z.string(), details: z.object({ path: z.string() }) }),
  ...
  z.object({ code: z.literal('inference-metrics-unconfigured'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('inference-metrics-unavailable'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('inference-metrics-too-large'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('inference-metrics-invalid'), message: z.string(), details: z.object({}) }),
