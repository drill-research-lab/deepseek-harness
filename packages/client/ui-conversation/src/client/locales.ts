...
export const zh = {
  ...
  'admissionQueue.position': '您的请求排在第 {n} 位',
...
export const zhTw = {
  ...
  'placeholder.parentOffline': '父工作階段已離線，無法繼續傳送；仍可停止目前的執行',
  ...
  'image.modelUnsupported': '目前的模型不支援圖片，請切換至支援圖片的模型',
  'image.subagentUnsupported': '子代理工作階段暫不支援圖片',
  ...
  'settings.enter.description': '僅在代理執行時期生效；Cmd/Ctrl+Enter 使用另一行為',
  'settings.enter.queue': '排隊傳送',
  'settings.enter.steer': '插話傳送',
  'access.confirm.title': '確認啟用 Full access？',
  'access.confirm.description': '啟用 Full access 後，agent 將減少確認步驟，並且可以直接執行更多操作，包括敏感操作、檔案修改或外部命令。僅建議在你信任目前的任務時使用。',
  ...
  'details.title': '詳情',
  'details.close': '關閉詳情',
  'details.empty': '點選訊息流中的工具行檢視詳情',
  'details.notInWindow': '該呼叫不在目前的視窗內',
  'details.input': '輸入',
  'details.output': '輸出',
  'details.running': '執行中…',
  'todo.title': '任務',
  ...
  'admissionQueue.position': '您的請求排在第 {n} 位',
...
export const en = {
  ...
  'admissionQueue.position': 'You are number {n} in line',
