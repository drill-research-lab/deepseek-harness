...
import { en, NS, zh, zhTw, type ConversationKey } from './locales.ts'
...
export function apply(ctx: Context): void {
  ...
  ctx.effect(() => ctx.locale.register(NS, { zh, 'zh-TW': zhTw, en }), 'ui-conversation: dictionaries')
  ...
  ctx.plugin(ConversationController, { input: inputHub, blocks: composerBlocks, viewStore: chatStore })
