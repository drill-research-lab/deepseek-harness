...
export const zhTw = {
  ...
  'nav': 'Agent 預設',
  'sectionIntro': '預設即一個工作階段的 Agent 所執行的外掛程式組裝 —— 它的工具、提示詞與能力。複製一份既有預設改成自己的，或用「創造模式」讓 Agent 幫你建立。',
  'builtIn': '內建',
  'setDefault': '設為預設',
  'view': '檢視',
  ...
  'presetCodeName': 'PTC 模式',
  'presetCodeDescription': '具備標準模式的全部能力，並通過 Code Mode SDK 呈現工具，讓模型用一個 TypeScript 程式組合多步操作。',
  'presetMinimalName': '極簡模式',
  'presetMinimalDescription': '僅提供持久 bash 與 str_replace_editor 的雙工具編碼 Agent。',
  'presetCordisName': '創造模式',
  'presetCordisDescription': '用於建立自訂 Agent preset：具備標準模式的全部能力，並提供執行時期檢查、外掛程式實驗和 preset 創作指導。',
  'duplicate': '複製',
