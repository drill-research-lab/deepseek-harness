...
export const zhTw = {
  'nav': '外掛程式',
  'title': '外掛程式',
  'intro': '設定和檢視本部署已安裝的外掛程式。',
  'tabs': '外掛程式檢視',
  'configurableTab': '外掛程式設定',
  'empty': '本部署沒有開放任何外掛程式設定。',
  'overridden': '已覆蓋',
  'reset': '復原預設',
  'readOnly': '本部署的設定為只讀。',
  'expand': '展開設定',
  ...
  'agentLoopMaxParallel': '平行工具呼叫數',
  'agentLoopMaxParallelHint': '同一步內最多同時執行多少個可平行的呼叫。',
  'webSearchTitle': '網頁搜尋',
  'webSearchDescription': 'DeepSeek 搜尋提供方。',
  'webSearchApiKey': 'API Key',
  'webSearchApiKeyHint': '不寫入設定檔。留空表示保留目前的金鑰。',
