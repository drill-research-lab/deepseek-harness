...
import { en, zh, zhTw, type SidebarKey } from './locales.ts'
...
export function apply(ctx: ClientContext): void {
  ctx.effect(() => ctx.locale.register(NS, { zh, 'zh-TW': zhTw, en }), 'ui-sidebar: dictionaries')
  ...
  ctx.effect(
    () => ctx.slots.register({
      ...
      children: {
        ...
        'sidebar.reports': { kind: 'single', scope: 'root' },
