...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /**
     * Feature-navigation region below the session browser. Declared by this
     * package's 'sidebar' entry; feature plugins (Pipelines today) register
     * their navigation block here against the same section owner share.
     */
...
export type SidebarRootComponentProps =
  ...
  & PropsRenderSlots<'sidebar.workspaces' | 'sidebar.pipelines' | 'sidebar.settings' | 'sidebar.footer.action'>
