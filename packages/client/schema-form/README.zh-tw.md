...
- **沒有通用算繪器**——消費端在這些輔助函式上建置功能專用表單。[Web 設定面 Agent Note](../../../.agents/notes/implemented/architecture/2026-07-30-web-config-plane.md) 記錄該權衡。
