...
import { en, NS, zh, zhTw, type SessionLogDownloadKey } from './locales.ts'
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => ctx.locale.register(NS, { zh, 'zh-TW': zhTw, en }), 'session-log-download: browser dictionaries')
