...
import writingRemote from '@deepseek-ai/dsh-writing-api/remote'
...
export type {} from '@deepseek-ai/dsh-writing-api/remote'
export type {} from '@deepseek-ai/dsh-writing-api/types'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, pluginInventoryRemote, messageFeedbackRemote, writingRemote,
    ]) {
