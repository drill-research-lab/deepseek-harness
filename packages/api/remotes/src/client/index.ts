...
import pipelinesRemote from '@deepseek-ai/dsh-pipeline-local/remote'
...
export type {} from '@deepseek-ai/dsh-pipeline-local/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, pipelinesRemote, dynamicRemote, pluginInventoryRemote, messageFeedbackRemote,
    ]) {
