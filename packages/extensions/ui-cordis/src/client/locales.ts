...
export const zhTw = {
  'row.defineTitle': '註冊 Cordis 外掛程式',
  'row.runTitle': '執行 Cordis 外掛程式',
  'row.updateTitle': '更新 Cordis 外掛程式',
  'row.stopTitle': '停止 Cordis 外掛程式',
  'row.removeTitle': '移除 Cordis 外掛程式',
  ...
  'panel.plugins.aria': 'Cordis 外掛程式',
  'panel.approvals.aria': 'Cordis 核准',
  'panel.trigger': 'Cordis Plugin',
  'panel.runningCount': '{count} running',
  'panel.title': 'Cordis 外掛程式',
  'panel.empty': '還沒有定義任何外掛程式',
  'panel.loading': '讀取中…',
  'panel.readFailed': '讀取外掛程式清單失敗：{message}',
  ...
  'action.approvePlugin': '允許此外掛程式的後續版本',
  'action.decline': '拒絕',
  'action.run': '執行',
  'action.stop': '停止',
  'action.remove': '移除',
  'action.retry': '重試',
  'action.rollback': '回退',
  'render.failedAbdicated': '{slot} 算繪失敗，已復原預設介面：',
  'render.failedHeld': '{slot} 算繪失敗：',
  'a11y.defining': '正在定義外掛程式',
  'a11y.failed': '定義失敗',
  'a11y.stopped': '定義已中斷',
  'body.source': '外掛程式程式碼',
  'body.hostCode': 'Host',
