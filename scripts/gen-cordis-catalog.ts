...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  PipelineDefinitionChange: 'pipeline.md',
  PipelineId: 'pipeline.md',
  PipelineNodeEndInfo: 'pipeline.md',
  PipelineNodeInfo: 'pipeline.md',
  PipelineRunInfo: 'pipeline.md',
  PipelineRunRequest: 'pipeline.md',
  PipelineRunResultInfo: 'pipeline.md',
  PipelineRunStart: 'pipeline.md',
  PipelineSaveRequest: 'pipeline.md',
  PipelineSummary: 'pipeline.md',
  WorkflowJson: 'pipeline.md',
