...
- The editor's run details show duration, node count, and error from the run record; per-node input/output and provenance views wait for the run-session slice.
