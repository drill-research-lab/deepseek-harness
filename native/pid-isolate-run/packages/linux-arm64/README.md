...
Static musl `pid-isolate-run` binary for linux-arm64. The entry package resolves this payload as a file path; it contains no JavaScript and is never imported.
